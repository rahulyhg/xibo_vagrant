...
--
-- Host: localhost    Database: xibodatabasename
-- ------------------------------------------------------
...
INSERT INTO `group` VALUES (1,'Users',0,0),(2,'Everyone',0,1),(3,'xiboadminname',1,0);
...
INSERT INTO `media` VALUES (9,'jquery-1.11.1.min.js','module',10,'jquery-1.11.1.min.js','jquery-1.11.1.min.js','3c9137d88a00b1ae0b41ff6a70571615',95785,1,0,0,NULL,1,1,0),(10,'xibo-layout-scaler.js','module',10,'xibo-layout-scaler.js','xibo-layout-scaler.js','3659986d00e56c929218084aeb991cca',2466,1,0,0,NULL,1,1,0),(11,'xibo-webpage-render.js','module',10,'xibo-webpage-render.js','xibo-webpage-render.js','8e9fe8361b485da58dc788389f88adfd',4338,1,0,0,NULL,1,1,0),(12,'moment.js','module',10,'moment.js','moment.js','04cfd84078efafd4ca0928326885cfa1',26051,1,0,0,NULL,1,1,0),(13,'jquery.marquee.min.js','module',10,'jquery.marquee.min.js','jquery.marquee.min.js','2286bb4f44d9ea301131a25c5204ca0a',2248,1,0,0,NULL,1,1,0),(14,'jquery-cycle-2.1.6.min.js','module',10,'jquery-cycle-2.1.6.min.js','jquery-cycle-2.1.6.min.js','4310a8127c98c2fc13d1f6597c338e6f',28669,1,0,0,NULL,1,1,0),(15,'xibo-text-render.js','module',10,'xibo-text-render.js','xibo-text-render.js','55991caa2c44b85d0604349da0f8c42b',9086,1,0,0,NULL,1,1,0),(16,'xibo-dataset-render.js','module',10,'xibo-dataset-render.js','xibo-dataset-render.js','ffcde6f93e4ac6cb6d4dddad45d344db',1585,1,0,0,NULL,1,1,0),(17,'flipclock.min.js','module',10,'flipclock.min.js','flipclock.min.js','cd44dfb10cf85968f429871c1334ee78',20242,1,0,0,NULL,1,1,0);
...
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8 COMMENT='Functional Modules';
/*!40101 SET character_set_client = @saved_cs_client */;
...
) ENGINE=InnoDB AUTO_INCREMENT=44 DEFAULT CHARSET=utf8 COMMENT='Available Pages';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `pages` VALUES (1,'dashboard',2),(2,'schedule',1),(3,'mediamanager',2),(5,'layout',3),(7,'content',4),(11,'display',7),(12,'update',11),(14,'admin',10),(15,'group',8),(16,'log',9),(17,'user',8),(18,'license',10),(19,'index',2),(24,'module',4),(25,'template',3),(26,'fault',10),(27,'stats',9),(28,'manual',2),(29,'resolution',12),(30,'help',2),(31,'clock',2),(32,'displaygroup',7),(33,'oauth',13),(34,'help',2),(35,'clock',2),(36,'dataset',14),(37,'campaign',3),(38,'transition',4),(39,'timeline',3),(40,'sessions',9),(41,'preview',3),(42,'statusdashboard',2),(43,'displayprofile',7);
...
INSERT INTO `session` VALUES ('j3t7oqah98pft59su9dnj20ep1','token|s:32:\"058fb10b7e86be8ead7060c1c6d44647\";token_timeout|i:1423709339;pagename|s:5:\"clock\";',1423710779,'2015-02-12 02:48:59','index',NULL,0,'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_2) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/40.0.2214.111 Safari/537.36','10.0.2.2',NULL);
...
INSERT INTO `user` VALUES (1,1,'xiboadminname','2c9c8d7c84e39555bc399ea4e044eb40',1,'2015-02-12 02:48:21','','statusdashboard',0,0,0);
...
INSERT INTO `version` VALUES ('1.7.1',4,2,85);
...
--
-- Dumping routines for database 'xibodatabasename'
--
...
-- Dump completed on 2015-02-12  2:59:55
